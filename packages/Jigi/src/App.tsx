import { Workspace, Toolbar, Contentbar, ImageObject } from 'jigi'
import { useState, useRef, useEffect } from 'react'
import { DEFAULT_BLEEDING_LINE_CONFIG, DEFAULT_BOARD_CONFIG, DEFAULT_KNIFE_LINE_CONFIG } from './config/constants'
...
function App() {
  ...
  const knifeLineData = {
    visible: true,
    export: true,
    width: DEFAULT_KNIFE_LINE_CONFIG.width
  }

  const bleedingLineData = {
    visible: true,
    export: true,
    width: DEFAULT_BLEEDING_LINE_CONFIG.width
  }
